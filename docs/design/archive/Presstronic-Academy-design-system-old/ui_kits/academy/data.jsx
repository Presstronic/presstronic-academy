...
window.AcademyData = {
  ...
  clearances: [
    { lvl: '01', name: 'Recruit', xp: '0', done: true },
    { lvl: '02', name: 'Operator', xp: '600', done: true },
    { lvl: '03', name: 'Specialist', xp: '1,800', done: true, now: true },
    { lvl: '04', name: 'Fixer', xp: '3,000', done: false },
    { lvl: '05', name: 'Legend', xp: '5,200', done: false },
  ],
};
